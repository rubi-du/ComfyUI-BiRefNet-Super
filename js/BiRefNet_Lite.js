...
app.registerExtension({
    name: "BiRefNet_Lite",
    async setup() {
        console.log("BiRefNet_Lite loaded");
	...
	loadedGraphNode(node) {
		...
		if (node.type === "BiRefNet_Lite") {
			...
			if(node.widgets_values[9] != undefined){
				localModelPathWidget.value = node.widgets_values[9];
			}
